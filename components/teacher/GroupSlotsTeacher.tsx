...
const LABELS = {
  ...
  ru: {
    ...
    maxReached: 'Максимум 3 будущих группы для этого предмета.',
...
export default function GroupSlotsTeacher({ teacherId, subjects, subjectFormats, subjectLevels, teachingLanguages, lang }: Props) {
  ...
  const canCreate = groupEnabledForSubject(formSubject)
        ...
        <div className="bg-gray-50 border border-gray-200 rounded-xl p-4 flex flex-col gap-3">
          ...
          <div className="grid grid-cols-2 gap-3">
            <div className="flex flex-col gap-1">
              ...
              <select
                value={formSubject}
                onChange={e => { setFormSubject(e.target.value); setFormLevels([]) }}
