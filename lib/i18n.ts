...
export const translations = {
  en: {
    ...
    form: {
      ...
      parentPref: "Parent's preferred contact",
      cancel: 'Cancel',
      confirm: 'Confirm',
      sending: 'Sending…',
  ...
  et: {
    ...
    form: {
      ...
      parentContact: 'Vanema telefon',
      parentEmail: 'Vanema e-post',
      parentPref: 'Vanema eelistatud kontakt',
      cancel: 'Tühista',
      confirm: 'Kinnita',
      sending: 'Saadan…',
  ...
  ru: {
    ...
    form: {
      ...
      parentContact: 'Телефон родителя',
      parentEmail: 'Email родителя',
      parentPref: 'Предпочтительный контакт родителя',
      cancel: 'Отмена',
      confirm: 'Подтвердить',
      sending: 'Отправка…',
