    ...
    body: (name: string, teacherName: string, courseSubject: string, level: string, teachingLangLabel: string, sessionLines: string, link: string) => `
      <div style="font-family:Inter,sans-serif;max-width:520px;margin:0 auto;padding:32px 24px;color:#1e1e2e">
        ...
        <div style="background:#eff6ff;border-radius:10px;padding:16px;margin-bottom:20px;border:1px solid #bfdbfe">
          <p style="margin:0 0 10px;font-size:13px;font-weight:600;color:#1d4ed8">Sessions</p>
          ${sessionLines}
        </div>
        <a href="${link}" style="display:inline-block;background:#3b82f6;color:#fff;font-weight:600;font-size:15px;padding:13px 28px;border-radius:10px;text-decoration:none">Book my group course</a>
  ...
  et: {
    ...
    body: (name: string, teacherName: string, courseSubject: string, level: string, teachingLangLabel: string, sessionLines: string, link: string) => `
      <div style="font-family:Inter,sans-serif;max-width:520px;margin:0 auto;padding:32px 24px;color:#1e1e2e">
        ...
        <div style="background:#eff6ff;border-radius:10px;padding:16px;margin-bottom:20px;border:1px solid #bfdbfe">
          <p style="margin:0 0 10px;font-size:13px;font-weight:600;color:#1d4ed8">Tunnid</p>
          ${sessionLines}
        </div>
        <a href="${link}" style="display:inline-block;background:#3b82f6;color:#fff;font-weight:600;font-size:15px;padding:13px 28px;border-radius:10px;text-decoration:none">Broneeri grupitund</a>
  ...
  ru: {
    ...
    body: (name: string, teacherName: string, courseSubject: string, level: string, teachingLangLabel: string, sessionLines: string, link: string) => `
      <div style="font-family:Inter,sans-serif;max-width:520px;margin:0 auto;padding:32px 24px;color:#1e1e2e">
        ...
        <div style="background:#eff6ff;border-radius:10px;padding:16px;margin-bottom:20px;border:1px solid #bfdbfe">
          <p style="margin:0 0 10px;font-size:13px;font-weight:600;color:#1d4ed8">Занятия</p>
          ${sessionLines}
        </div>
        <a href="${link}" style="display:inline-block;background:#3b82f6;color:#fff;font-weight:600;font-size:15px;padding:13px 28px;border-radius:10px;text-decoration:none">Записаться в группу</a>
